...
function HowItWorks() {
  return (
    <section id="how-it-works" className="scroll-mt-5 py-24 relative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto " >
      {/* HEADER */}
      ...
      <div className="relative">
        {/* CONNECTION LINE */}
        <div className="absolute top-1/2 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#0ea5e9] to-transparent transform -translate-y-1/2 hidden lg:block opacity-50 shadow-[0_0_15px_rgba(14,165,233,0.5)]"></div>
